...
#define SWITCHES_BASE_ADDRESS     0x00081030   // Value TBD by QSys
#define RED_LED_BASE_ADDRESS      0x00081040   // Value TBD by QSys
#define BUTTONS_BASE_ADDRESS      0x00081050   // Value TBD by QSys
...
void main()
{
   ...
   __builtin_wrctl(3, 1);   // Write 2 to ienable reg to enable buttons IRQ

   *(buttonPtr + 2) = 0x1;  // Enable button 2 "KEY2" to cause an IRQ
